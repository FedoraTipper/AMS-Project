...
SQL_Statements.append("CREATE TABLE user( user_id  int NOT NULL AUTO_INCREMENT , username varchar(150) NOT NULL , password varchar(255) NOT NULL , admin    int NOT NULL ,PRIMARY KEY (user_id));")
...
SQL_Statements.append("""CREATE TABLE nodes( node_id  int NOT NULL AUTO_INCREMENT , type     varchar(255) NOT NULL , user_id  int NOT NULL , label_id int ,PRIMARY KEY (node_id),KEY fkIdx_123 (label_id),CONSTRAINT FK_123 FOREIGN KEY fkIdx_123 (label_id) REFERENCES labels (label_id),KEY fkIdx_81 (user_id), CONSTRAINT FK_81 FOREIGN KEY fkIdx_81 (user_id) REFERENCES user (user_id));""")
